...
class SummarySlide : GreetingSlide<DiscordSlide>(DiscordSlide::class.java) {
    val text by UIWrappedText("""
        ...
        By default, SkyClient provides some built-in mods, such as ${ChatColor.BOLD}SkyClient Updater${ChatColor.RESET} and ${ChatColor.BOLD}SkyClient Cosmetics${ChatColor.RESET} which enhances the SkyClient experience.
